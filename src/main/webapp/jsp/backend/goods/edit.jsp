...
<form id="edit_form" method="post" enctype="multipart/form-data"
	...
	<table class="editTable">
		<tr>
			<th>品牌中文名</th>
			<td><input type="hidden" id="id" name="id" value="${brand.id}" />
				<input type="text" id="nameZh" name="nameZh" value="${brand.nameZh}"
				class="easyui-validatebox" data-options="required:true" /></td>
		</tr>
		<tr>
			<th>品牌英文名</th>
			<td><input type="text" id="nameEn" name="nameEn"
				value="${brand.nameEn}" class="easyui-validatebox"
				data-options="required:true" /></td>
		</tr>
		<tr>
			<th>品牌logo</th>
			<td><img src="${ctx}${brand.logo}" style="border: 1px solid;"></td>
		</tr>
		<tr>
			<th>修改品牌logo</th>
		...
		<tr>
			<th>品牌中文描述</th>
			<td><textarea id="descZh" name="descZh"
					style="width: 100%; height: 200px;">${brand.descZh}</textarea></td>
		</tr>
		<tr>
			<th>品牌英文描述</th>
			<td><textarea id="descEn" name="descEn"
					style="width: 100%; height: 200px;">${brand.descEn}</textarea></td>
		</tr>
	</table>
</form>
...
<script type="text/javascript">
	var editor;
	$(function() {
		window.editor = KindEditor.create('textarea[id="descZh","descEn"]', {
			resizeType : 1,
			newlineTag : "p",

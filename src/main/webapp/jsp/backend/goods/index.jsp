...
<script type="text/javascript">
	...
	$(function() {
		...
		datagrid = $("#datagrid").datagrid({
			url : '${ctx}/backend/groupManager/loadData',
			fit : true,
	...
	function add() {
		addData("添加", "#add_form", datagrid,
				"${ctx}/backend/groupManager/add", edit_W, edit_H, false);
	}
	function edit(rowIndex, rowData) {
		editData(rowIndex, rowData, "编辑", '#edit_form', datagrid,
				"${ctx}/backend/groupManager/edit", edit_W, edit_H, "", false);
	}
	function del() {
		delData(datagrid, "${ctx}/backend/groupManager/del");
	}
</script>

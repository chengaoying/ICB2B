...
$(function(){
	...
	datagrid = $("#datagrid").datagrid({
		url: '${backend_uri}/userAddress/loadData',
		fit: true,
...
function add(){
	addData("添加","#edit_form",datagrid,"${backend_uri}/userAddress/add",edit_W,edit_H);
}
function edit(rowIndex,rowData){
	editData(rowIndex,rowData,"编辑",'#edit_form',datagrid,"${backend_uri}/userAddress/edit",edit_W,edit_H);
}
function del(){
	delData(datagrid,"${backend_uri}/userAddress/del");
}

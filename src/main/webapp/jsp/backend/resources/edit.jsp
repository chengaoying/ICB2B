	...
	<table class="editTable">
		<tr>
			...
			<td>
				...
				<input type="text" id="nameZh" name="nameZh" value="${resource.nameZh }"/><em>*</em>
			</td>
		</tr>
		<tr>
			<th>资源英文名称</th>
			<td><input type="text" id="nameEn" name="nameEn" value="${resource.nameEn }"/><em>*</em></td>
		</tr>
		<tr>
			<th>访问地址</th>
			<td><input type="text" id="url" name="url" value="${resource.url }"/></td>
		</tr>
	</table>
</form>

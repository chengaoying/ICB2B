	...
	<div id="datagrid_toolbar" style="padding:5px;">
	   <div style="float: left;"  style="height:25px;">
	        <form method="post" id="search_form" style="padding: 0px;">
				<input type="text" name="id" placeholder="请输入用户帐号称或ID" style="width: 140px"></input>
...
$(function(){
	...
	datagrid = $("#datagrid").datagrid({
		url: '${backend_uri}/sysUser/loadData',
		fit: true,
        ...
        columns:[[    
	        ...
	        {field:'role',title:'所属角色',width:120,
	        ...
	        {field:'lastIp',title:'最近登入IP',width:150}, 
	        {field:'lastTime',title:'最近登入时间',width:150,
	        	formatter:function(value,row,index){
...
function add(){
	addData("添加","#edit_form",datagrid,"${backend_uri}/sysUser/add",edit_W,edit_H);
}
function edit(rowIndex,rowData){
	editData(rowIndex,rowData,"编辑",'#edit_form',datagrid,"${backend_uri}/sysUser/edit",edit_W,edit_H);
}
function del(){
	delData(datagrid,"${backend_uri}/sysUser/del");
}
